...
const placements: FurniturePlacement[] = [
  ...
  },
  {
    ...
    floor: "upper",
    position: [2.48, STORY_HEIGHT + 0.03, 0.02],
    rotation: 0.22,
    targetSpan: 0.62,
  },
  {
    ...
    floor: "upper",
    position: [-2.25, STORY_HEIGHT + 0.03, -2.7],
    rotation: Math.PI,
    targetSpan: 2.25,
